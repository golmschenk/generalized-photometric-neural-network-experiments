...
log_name = '/Users/golmsche/Desktop/HadesWithAuxiliaryNoSigmoid_2021_09_30_15_26_49'  # Specify the path to the model to use.
...
model = HadesWithAuxiliaryNoSigmoid(database.number_of_label_values)
