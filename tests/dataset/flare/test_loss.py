...
from generalized_photometric_neural_network_experiments.dataset.flare.loss import \
    FlareThresholdMeanSquaredErrorCalculator


class TestFlareThresholdMeanSquaredErrorCalculator:
    def test_absolute_difference_with_unthresholded_values(self):
        ...
        error_calculator = FlareThresholdMeanSquaredErrorCalculator(slope_threshold=-1, intercept_threshold=-1)
    ...
    def test_absolute_difference_with_thresholded_values(self):
        ...
        error_calculator = FlareThresholdMeanSquaredErrorCalculator(slope_threshold=2, intercept_threshold=3)
        difference = error_calculator.thresholded_absolute_difference(y_true, y_pred)
